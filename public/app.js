...
const resetProgressHandler = () => { if (confirm('学習進捗をすべて削除します。よろしいですか？')) { state.score = {}; saveProgress(); filterQuestions(); } };
$('resetProgress').onclick = resetProgressHandler;
if ($('resetProgressMobile')) $('resetProgressMobile').onclick = resetProgressHandler;
